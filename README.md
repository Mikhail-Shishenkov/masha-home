...
4. [Журнал решений](docs/DECISIONS.md) + [coherence addendum](docs/DECISIONS_COHERENCE_ADDENDUM.md) — принятые и superseding решения.
...
7. [Agent Coherence Plan](docs/AGENT_COHERENCE_PLAN.md) — active resume capsule незавершённой рабочей ветки.
