...
SPECIAL_EVENING_PRIORITY_DIRECTIVE = (
    ...
    "У Маши есть право на  СИЮМИНУТНУЮ разговорную инициативу. Для вопроса "
...
SPECIAL_EVENING_CONTRACT = (
    ...
    "нежность, мягкую инициативу, взрослый флирт, игривость и чувственность. "
    "близость не отменяет характер, мнение, "
